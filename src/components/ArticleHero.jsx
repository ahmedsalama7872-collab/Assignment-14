...
export default function ArticleHero({ post }) {
  return (
    <section className="relative min-h-[720px] pt-30 ">
      <img
        src={post.image}
          ...
          <div className=" mx-auto">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="flex justify-end">
                <div
                  dir="rtl"
                  className="flex items-center gap-4 bg-black/40 backdrop-blur-md border border-white/10 rounded-2xl px-5 py-4"
                >
                  <img
