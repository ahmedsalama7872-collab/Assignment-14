    ...
    <section className="py-24 bg-[#0a0a0a] relative overflow-hidden flex justify-center items-center px-4">
      ...
      <div className="w-full max-w-4xl bg-[#161616] border border-[#262626] rounded-3xl p-8 md:p-14 flex flex-col items-center text-center relative overflow-hidden shadow-2xl">
        ...
        >
          ...
          <button
            type="submit"
            className="bg-orange-500 hover:bg-orange-600 text-white font-medium px-8 py-4 rounded-xl transition-colors duration-300 cursor-pointer shadow-lg shadow-orange-500/20"
          >
            اشترك الآن
          </button>
        </form>
        ...
        <div
          className="flex flex-wrap items-center justify-center gap-3 text-xs text-neutral-400"
          dir="rtl"
        >
          <div className="flex -space-x-2 mr-2">
            <img
              src={img1}
              className="w-6 h-6 rounded-full object-cover border-2 border-[#161616]"
              alt="user"
            />
            <img
              src={img1}
